...
let center = [40.641766, -97.6687];
let map = L.map('mapid').setView(center, 4);

// Coordinates for each point to be used in the polyline.
let SFO = [37.6213, -122.379];
let JFK = [40.641766, -73.780968];
let AUS = [30.19, -97.6687];
let YYZ = [43.6777, -79.6248];
let TUC = [32.25346, -110.911789];

let line = [SFO, TUC, AUS, YYZ, JFK];

// Create polyline using the line coordinates and options.
L.polyline(line, lineOpts).addTo(map);
